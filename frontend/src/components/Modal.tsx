 ...
 * 
 * Komponen modal reusable untuk menampilkan dialog atau form
 * 
 * Props:
 ...
 * - footer: Custom footer content (opsional)
 * 
 * Usage:
 * <Modal isOpen={isOpen} onClose={() => setIsOpen(false)} title="Add OLT">
 *   <FormContent />
 * </Modal>
 */
